    ...
    <div className="event-item card">
      <div className="event-item__content">
        <div>
          ...
          <p>
            Address:{' '}
            <a
              href={`https://maps.google.com/?q=${event.data.address}`}
              target="_blank"
              rel="noreferrer">
              {event.data.address}
            </a>
        ...
        {user.uid === event.data.uid ? (
          <div className="event-item__delete">
            <button
              className="event-item__delete-button"
      ...
      <div className="event__guests">
        <p>
          Going:{' '}
          {event.data.going
            ? event.data.going.map((going) => `${going.name} ${going.time}`)
            : 'None'}
        </p>
        <p>
          Not going:{' '}
          {event.data.notGoing
            ? event.data.notGoing.map((notGoing) => notGoing.name)
            : 'None'}
        </p>
        <p>Comments:</p>
